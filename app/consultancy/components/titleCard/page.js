    ...
    <>
        <Grid className='bb' >
            <div className='container p-4'>
                ...
                <Typography level="title-lg">Prem Chopra</Typography>
                <Typography className="w-[30%] " level="body-sm">
                     Credentials of doctor
                </Typography>
                <div className='mt-3'><Button className='w-[20%]' variant="outlined" color="neutral">
                    Chat
                 </Button></div>
                
                </div>

                <div><Typography component="legend">Rating</Typography>
